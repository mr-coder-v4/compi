...
async def storage(event):
    ...
    d_t = disk.total/1024.0/1024.0/1024.0,1
    d_u = disk.used/1024.0/1024.0/1024.0,1
    d_p = disk.percent
    d_f = disk.free/1024.0/1024.0/1024.0,1
    memory = psutil.virtual_memory()
    swap = psutil.swap_memory()
    mem_p = memory.percent
    mem_t = memory.total/1024.0/1024.0/1024.0,1
    mem_a = memory.available/1024.0/1024.0/1024.0,1
    mem_f = memory.free/1024.0/1024.0/1024.0,1
    mem_u = memory.used/1024.0/1024.0/1024.0,1
